        ...
        {isLoading ? (
          ...
          filteredItems.map(item => (
            ...
            >
              ...
              <h3 style={{ margin: '0 0 0.5rem 0', color: item.resolved ? 'var(--text-muted)' : '#34d399' }}>
                 {item.title}
              </h3>
              ...
              {item.location && <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}><strong>Found at:</strong> <span style={{ color: '#ffffff' }}>{item.location}</span></p>}
            </div>
          ))
        )}
      </div>
