        ...
        {isLoading ? (
          ...
          <div className="glass-panel" style={{ padding: '2.5rem', gridColumn: '1 / -1', textAlign: 'center' }}>
            <h2 style={{ fontSize: '3rem', margin: '0 0 1rem 0' }}>🔍</h2>
             <h3 style={{ color: 'var(--text-light)', marginBottom: '0.5rem' }}>No lost items found</h3>
             <p style={{ color: 'var(--text-muted)' }}>Try adjusting your search filters or check back later.</p>
          </div>
        ) : (
